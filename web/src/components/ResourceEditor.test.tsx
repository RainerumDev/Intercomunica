...
describe("ResourceEditor", () => {
  it("removes unavailable subgroup IDs while preserving the rest of the edited draft", async () => {
    ...
    const stale: Subgroup = { id: "stale", name: "Stale", description: null, color: null, members: [] };
    const retained: Subgroup = { id: "retained", name: "Retained", description: null, color: null, members: [] };
    const replacement: Subgroup = { id: "replacement", name: "Replacement", description: null, color: null, members: [] };
  ...
  it("reports invalid URL, missing title, and missing subgroup accessibly on submit", async () => {
    ...
    render(
      <ResourceEditor
        initialDraft={emptyResourceDraft}
        subgroups={[{ id: "group-1", name: "Lettere", description: null, color: null, members: [] }]}
        onSave={onSave}
        onCancel={() => {}}
      />
    );
