...
- Applicare i token istituzionali già presenti: `--brand: #b8181b`, `--brand-hover: #8f1114`, `--ink: #261816`, `--muted: #6a5552`, `--page: #fff8f7`, `--surface: #ffffff`, `--surface-soft: #fff0ee`, `--line: #dbbeba` e `--focus: #004075`. Mappare questi valori alle variabili consumate dall'app; non rinominare ogni consumatore senza motivo.
